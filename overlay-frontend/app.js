(function () {
    ...
    $().ready(function () {
        ...
        socket.on('update', function (data) {
            ...
            updateBasedOnStore(data.botStore);
        });

        function updateBasedOnStore(data) {
            if(data.schimmelCount > 0) {
                schimmelCounter.parent().removeClass('hide');
                schimmelCounter.text(data.schimmelCount);
            } else {
                schimmelCounter.parent().addClass('hide');
            }
        }
